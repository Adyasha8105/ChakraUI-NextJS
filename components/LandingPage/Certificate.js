			...
			>
				...
				>
					...
					<Heading
						...
						textAlign={["center", "center", "left", "left"]}
					>
						<Text as="abbr" color="white" opacity="0.7" fontWeight="normal">
							Our physical certificates are legal documents approved by an IP lawyer, printed in
							four copies, secured with a quintuplicate chirograph with QRCode and blockchain
							identifiers.
						</Text>
					</Heading>
					{/* <Link to="/signup"> */}
